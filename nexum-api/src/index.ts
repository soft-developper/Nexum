...
app.use('/transactions',   maintenanceGuard('send'),        transactionsRouter)
...
app.use('/bridge',         maintenanceGuard('bridge'),      bridgeRouter)
app.use('/ramp',           maintenanceGuard('ramp'),        rampRouter)
